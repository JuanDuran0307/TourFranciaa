...
async function mostrarPremios() {
    ...
    premios.forEach((premio) => {
        ...
        <div class="cookie-card">
            <span class="title">🚴‍♂ ${premio.nombre}</span>
            <p class="description">Descripcion: ${premio.descripcion}</p>
            <p class="description">Ganador: ${premio.ganador}</p>
            <p class="description">Equipo: ${premio.equipo}</p>
            <div class="btnEditDelete">
                <button class="edit-button update" id="${premio._id}" data-bs-toggle="modal" data-bs-target="#modalUpdate">
                ...
                <button class="delete-button eliminar" id="${premio._id}">
