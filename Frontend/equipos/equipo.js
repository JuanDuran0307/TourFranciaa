...
async function loadEquipo() {
    ...
    equipos.forEach((equipo) => {
        ...
        <div class="cookie-card">
            ...
            <p class="description">Equipo: ${equipo.pais}</p>
            <p class="description">Edad: ${equipo.director}</p>
            <div class="btnEditDelete">
                <button class="edit-button update" id="${equipo._id}" data-bs-toggle="modal" data-bs-target="#modalUpdate">
                ...
                <button class="delete-button eliminar" id="${equipo._id}">
...
async function getInfo(e){
    if (e.target.classList.contains("update")) {
        ...
        const {_id,nombre,pais,director} = informacion;
